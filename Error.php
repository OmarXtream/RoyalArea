...
<body id="wrapper-404">
    ...
    <div class="container">
        <div class="errorpage">
            ...
            <h1 style="color:#aa007f">خطأ</h1>
            <p><strong>لم يتم العثور على الصفحة</p>
           <strong> <h3><strong>يبدو أن هناك خطأ ما !. <a href="./" class="btn btn-sm btn-primary" title='اضغط هنا للعودة الى الصفحة الرئيسية'>العودة</a></h5>
        </div>
    </div>
    <!-- end:wrapper -->
